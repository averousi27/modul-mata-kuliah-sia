                    ...
                    <div class="row">
                        <div class="col-md-4 center">
                            <div class="login-box">
                                ...
                                <div class="alert alert-danger text-center" role="alert" <c:if test="${errorMessage==null}">style="display:none"</c:if>>
	                       			${errorMessage }
	                    		</div>
                                <form class="m-t-md" method="post" action="${pageContext.servletContext.contextPath}/loginsubmit">
