			...
			<script src="${pageContext.servletContext.contextPath}/resources/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js" type="text/javascript"></script>
									 ...
									 <div="row">
									 	<div class="col-md-8 col-md-offset-2"> 
									 		<div class="form-group">
												...
												<button type="button" class="btn btn-default" onclick="showReport(this)">Tampilkan</button>
												<div class="hide">
													<div class="row">
														<div class="col-md-10 col-md-offset-1"> 
															<h5>Silabus Kurikulum</h5>
															<table>
																<tr> 
																	<c:forEach items="${mk}" var="mk"> 
																		<td>${mk.kodeMK} | ${mk.namaMK}</td>
																	</c:forEach> 
																</tr>
																<tr> 
																	<c:forEach items="${cpmk}" var="cpmk"> 
																		<td>${cpmk.namaCapPembMK}</td>
																	</c:forEach> 
																</tr>
																<tr> 
																	<c:forEach items="${detailSilabus}" var="ds"> 
																		<td>${ds.pokokBahasan}</td>
																	</c:forEach> 
																</tr>
															</table> 
														</div>
				...
				<script>
					$(document).ready(function(){ 
						showReport = function showReport(button){
							$.ajax({
								data: $
							});
						}
